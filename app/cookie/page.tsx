        ...
        <section className="py-16 md:py-20 bg-white" aria-label="Contenuto Cookie Policy">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-10 text-[#1a3a6b]/75 leading-relaxed">
              <section>
                <h2 className="text-xl font-bold text-[#1a3a6b] mb-3">1. Cosa sono i cookie</h2>
                <p>
                ...
                <p className="mt-3">
                  ...
                  <Link href="/privacy" className="text-[#1e9ed6] hover:underline">Privacy Policy</Link>.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-bold text-[#1a3a6b] mb-3">2. Titolare</h2>
                <p>
                  Il Titolare del trattamento è <strong className="text-[#1a3a6b]">Rete Italiana Disabili ETS</strong>.
                  Per contatti: {' '}
              ...
              <section>
                <h2 className="text-xl font-bold text-[#1a3a6b] mb-3">3. Tipologie di cookie utilizzati</h2>

                <h3 className="text-lg font-semibold text-[#1a3a6b] mt-6 mb-2">3.1 Cookie tecnici (necessari)</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold text-[#1a3a6b] mt-6 mb-2">3.2 Cookie analitici</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold text-[#1a3a6b] mt-6 mb-2">3.3 Cookie di profilazione / marketing</h3>
                <p>
                  Al momento <strong className="text-[#1a3a6b]">questo sito non utilizza cookie di profilazione
              ...
              <section>
                <h2 className="text-xl font-bold text-[#1a3a6b] mb-3">4. Base giuridica</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#1a3a6b] mb-3">5. Come gestire i cookie</h2>
                <p>
                ...
                <ul className="mt-3 list-disc pl-5 space-y-2">
                  <li>
                    <a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-[#1e9ed6] hover:underline">Google Chrome</a>
                  </li>
                  <li>
                    <a href="https://support.mozilla.org/it/kb/Gestione%20dei%20cookie" target="_blank" rel="noopener noreferrer" className="text-[#1e9ed6] hover:underline">Mozilla Firefox</a>
                  </li>
                  <li>
                    <a href="https://support.apple.com/it-it/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-[#1e9ed6] hover:underline">Safari</a>
                  </li>
                  <li>
                    <a href="https://support.microsoft.com/it-it/microsoft-edge/eliminare-i-cookie-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-[#1e9ed6] hover:underline">Microsoft Edge</a>
                  </li>
                </ul>
              </section>

              <section>
                <h2 className="text-xl font-bold text-[#1a3a6b] mb-3">6. Diritti dell&apos;interessato</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#1a3a6b] mb-3">7. Aggiornamenti</h2>
                <p>
